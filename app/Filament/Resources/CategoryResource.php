    ...
    public static function form(Form $form): Form
{
    return $form
        ->schema([
            TextInput::make('name')
                ->required()
                ->live(onBlur: true) // Agar saat diketik, slug otomatis terisi
            ...
            TextInput::make('slug')
                ->required()
                ->disabled() // Supaya tidak diubah manual sembarangan
                ->dehydrated() // Agar tetap terkirim ke database meski disabled
