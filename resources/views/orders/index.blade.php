    ...
    <div class="container mx-auto px-4 py-8 max-w-3xl">
        @if($orders->isEmpty())
            <div class="text-center py-20">
                ...
                <a href="{{ route('home') }}" class="mt-4 inline-block bg-green-600 text-white px-6 py-2 rounded-full">Mulai Belanja</a>
            </div>
        @else
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between items-center mb-2 last:mb-0">
                            ...
                            <span class="text-sm font-semibold text-gray-600">Rp {{ number_format($item->price * $item->quantity, 0, ',', '.') }}</span>
                        </div>
                        @endforeach
                    </div>
