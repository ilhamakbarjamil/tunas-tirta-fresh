...
<body class="bg-gray-50 font-sans">
    ...
    <nav class="bg-tosca text-white shadow-lg sticky top-0 z-50">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <a href="https://wa.me/62812345678"
                class="bg-white text-tosca px-4 py-2 rounded-full font-semibold hover:bg-gray-100 transition">
                Hubungi Kami
            </a>
        </div>
    </nav>
    ...
    <header class="bg-tosca-light py-16 text-center">
        <div class="container mx-auto px-4">
            ...
            <a href="#katalog"
                class="bg-pink hover:bg-pink-hover text-white px-8 py-3 rounded-full text-lg font-bold shadow-md transition">
                Lihat Katalog
            </a>
        </div>
    </header>
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    @foreach ($category->products as $product)
                        <div
                            class="bg-white rounded-xl shadow-md hover:shadow-xl transition overflow-hidden border border-gray-100 group">
                            ...
                            <div class="p-4">
                                ...
                                @if ($product->price)
                                    <p class="text-pink font-bold">Rp {{ number_format($product->price, 0, ',', '.') }}
                                    </p>
                                @else
